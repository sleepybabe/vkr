function checkVariantCriterion() {
    ...
    if (!isCorrect)
        return ['6 задание (курсор меняет цвета): не выполнено.', 'Прямоугольник не стал красным при наведении курсора мыши или белым при "уходе".'];
    else 
        return ['6 задание (курсор меняет цвета): выполнено.','Процент:', 25];
}